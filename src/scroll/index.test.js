...
describe('Scroll', () => {
  ...
  it('should have an id', () => {
    const scroll = new Scroll(1, lastCleaningDate, 1, catalog);
  ...
  describe('hasTag', () => {
    const scroll = new Scroll(1, lastCleaningDate, 2, catalog);
  ...
  describe('daysSinceLastCleaning', () => {
    it('should return the difference in days between last cleaned date and target date', () => {
      const scroll = new Scroll(2, lastCleaningDate, 2, catalog);
